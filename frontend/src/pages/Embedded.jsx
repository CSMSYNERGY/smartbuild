// frontend/src/pages/Embedded.jsx
...
export default function Embedded() {
  ...
  const handleAuthenticate = async () => {
    ...
    try {
      ...
      // success: SESSION cookie set (overwrites any existing one)
      setStatus("success");
      setIsLoading(false);
  ...
  if (isLoading) {
    ...
    buttonLabel = "Retry authentication";
  }
    ...
    <div className="sb-embed-root">
      <div className="sb-embed-card">
        ...
        <button
          ...
          className={
            "sb-embed-button" +
            (isButtonDisabled ? " sb-embed-button--disabled" : "")
          }
        >
          {buttonLabel}
        </button>
        ...
        <div className="sb-embed-footnote">
          This page stays inside GoHighLevel so you can quickly refresh your
          connection without leaving the platform.
        </div>
      </div>
    </div>
  );
